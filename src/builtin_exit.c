...
/*   Updated: 2024/04/04 14:49:14 by sdemaude         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (arg->cmd_list->arguments[1])
	{
		if (!ft_islong(arg->cmd_list->arguments[1]))
		{
			ft_putstr_fd("exit : numeric argument required\n", 2);
			arg->exit_code = 2;
		}
		else if (arg->cmd_list->arguments[2])
		{
			...
			arg->exit_code = ft_atoi(arg->cmd_list->arguments[1]);
	}
	return (true);
}
